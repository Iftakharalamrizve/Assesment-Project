<template>
  ...
  <div class="topbar">
    ...
    <div class="topbar-left">
      <a href="/" class="logo">
        <span>
          <img src="/admin_template/images/logo-light.png" alt height="18" />
        </span>
        <i>
          <img src="/admin_template/images/logo-sm.png" alt height="22" />
        </i>
      </a>
    </div>
    <nav class="navbar-custom">
      <ul class="navbar-right d-flex list-inline float-right mb-0">
        <li class="d-none d-sm-block">
            <div class="mb-0 breadcrumb" v-for="(breadcrumb,index) in breadcrumbs" :key="index">
                <router-link :to="{ name: 'add-purchase'}" class="waves-effect">
        ...
        <li class="dropdown notification-list">
          <div class="dropdown notification-list nav-pro-img">
            <a
              ...
              aria-expanded="false"
            >
              <img src="/admin_template/images/users/user-4.jpg" alt="user" class="rounded-circle" />
            </a>
            <div class="dropdown-menu dropdown-menu-right profile-dropdown">
              ...
              <a class="dropdown-item text-danger" @click="$store.dispatch('logout')">
