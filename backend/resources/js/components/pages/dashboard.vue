          ...
          <div class="card-body">
            ...
            <div class="inbox-wid">
              <a href="#" class="text-dark">
                <div class="inbox-item">
                  <div class="inbox-item-img float-left mr-3">
                    <img src="assets/images/users/user-1.jpg" class="thumb-md rounded-circle" alt />
                  </div>
              ...
              <a href="#" class="text-dark">
                <div class="inbox-item">
                  <div class="inbox-item-img float-left mr-3">
                    <img src="assets/images/users/user-5.jpg" class="thumb-md rounded-circle" alt />
                  </div>
              ...
              <a href="#" class="text-dark">
                <div class="inbox-item">
                  <div class="inbox-item-img float-left mr-3">
                    <img src="assets/images/users/user-6.jpg" class="thumb-md rounded-circle" alt />
                  </div>
        ...
        <div class="card widget-user m-b-20">
          <div class="widget-user-desc p-4 text-center bg-primary position-relative">
            ...
            <p class="text-white mb-0">
              ...
              same vocabulary. The languages only in their grammar.
            </p>
          </div>
          <div class="p-4">
                  ...
                  <tr>
                    ...
                    <td>
                      <img
                        ...
                        alt="user-image"
                        class="thumb-sm mr-2 rounded-circle"
